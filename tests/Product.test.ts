...
test('Test product data', async({page})=>{
    ...
    const productDescription = "A red light isn't the desired state in testing but it sure helps when riding your bike at night. Water-resistant with 3 lighting modes, 1 AAA battery included.";
    const productPrice = "$9.99"
    await productPageActions.checkProductData(productName, productDescription, productPrice);
